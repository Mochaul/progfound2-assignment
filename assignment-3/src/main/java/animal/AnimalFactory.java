...
public class AnimalFactory{
    ...
    public void addAnimal(String[] arr){
        ...
        if (arr[7].equals("healthy")) h = true;
        else h = false; 
        if (arr[3].equals("male")) g = true;
        else g = false;

        // TODO add canPeform method
        if (arr[1].equals("Hamster")){
            if (arr[6].equals("pregnant") || !h) canPerform =  false;
            ...
            if (arr[6].equals("pregnant") || arr[4].equals("female") || !h) canPerform =  false;
            ...
            if (arr[6].equals("laying eggs") || !h) canPerform =  false;
            ...
            if (!arr[6].equals("tame") || !h) canPerform =  false;
